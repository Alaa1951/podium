...
export const AR_CORE: Phrases = {
  ...
  "has left your zone — submit before the next wave arrives.": "خرجت من الزون بتاعتك — سلّم قبل ما الموجة الجاية توصل.",
  "No team in your zone in this wave.": "مفيش فريق في الزون بتاعتك في الموجة دي.",
  "Wave {wave} reaches Zone {zone} in {time}.": "الموجة {wave} هتوصل زون {zone} بعد {time}.",
  "No team in your zone right now.": "مفيش فريق في الزون بتاعتك دلوقتي.",
  "No team on your zone or station right now.": "مفيش فريق على الزون أو الاستيشن بتاعتك دلوقتي.",
  "Wave {wave} is on the floor and reaches Zone {zone} in {time}. Your team appears here by itself.": "الموجة {wave} على الأرض وهتوصل زون {zone} بعد {time}. فريقك هيظهر هنا لوحده.",
  "A team appears here by itself when a wave that has started reaches Zone {zone}.": "الفريق هيظهر هنا لوحده أول ما موجة بدأت توصل زون {zone}.",
  "The next wave has reached your zone, so this team is closed for you. Your zone leader can still submit it.": "الموجة الجاية وصلت الزون بتاعتك، فالفريق ده اتقفل عليك. قائد الزون لسه يقدر يسلّمه.",
