...
export function PlainHeader({ roleLabel, homeHref = "/", backHref }: { roleLabel: string; homeHref?: string; backHref?: string }) {
  ...
  const mobileTitle = ({"/home":"Home","/me":"My team","/studio":"Competitions","/my-wave":"My wave","/account":"Account","/notifications":"Notifications","/me/edit":"Edit team","/me/partner":"Find a partner","/me/partner/requests":"Partner requests"} as Record<string,string>)[path] ?? (path.startsWith("/studio/announcements") ? "Announcements" : path.startsWith("/my-wave/") ? "My wave" : undefined);
