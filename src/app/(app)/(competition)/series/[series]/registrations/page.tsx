...
import { getArchivedTeams, getSeriesTeams } from "@/lib/queries";
 ...
 */
export default async function RegistrationsPage(props: PageProps<"/series/[series]/registrations">) {
  ...
  const rows: RegisteredRow[] = filtered.map((team) => ({
    id: team.id,
    number: team.number,
    name: team.name,
  ...
  return (
    <div className="screen">
      ...
      <RegisteredTable
        ...
        seriesId={series.id}
        canArchive={series.status === "scheduled"}
