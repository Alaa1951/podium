import { getNotificationSummary, getNotificationUser, listNotifications } from "@/lib/notifications";
...
export async function GET(request: Request) {
  ...
  if (params.get("summary") === "1") return Response.json(await getNotificationSummary(user), { headers });
